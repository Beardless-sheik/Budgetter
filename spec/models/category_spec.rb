...
describe Category, type: :model do
  ...
  describe 'check model method - "check_payment_total" ' do
    ...
    it 'should return total of all payments if payments are present' do
      Payment.create(Name: 'Mc Donalds', Amount: 50, user: @user, category_id: @category4.id)
      Payment.create(Name: 'Hungry Lion', Amount: 50, user: @user, category_id: @category4.id)
